from tests.helper import FlaskTestCase
...
class TestApiSeat(FlaskTestCase):
    def test_seats_lock(self):
        locket_seats_num = len(sid_list)
        ...
        self.assertEqual(rv["data"]["locked_seats_num"], locket_seats_num)
        ...
        self.assertEqual(succ_count, locket_seats_num)
